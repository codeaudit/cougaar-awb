...
CONVERTED2DOT5 = True
TODO = '''
Is this used in the AWB implementation?
external references
agentController.py:#~ from societyVisualModel import *
facetProperties.py:from societyVisualModel import *
servletProperties.py:from societyVisualModel import *
societyController.py:from societyVisualModel import *
'''
#---------------------------------------------------------------------------
